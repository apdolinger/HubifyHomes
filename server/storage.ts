...
export class DatabaseStorage implements IStorage {
  ...
  async getTask(id: number): Promise<Task | undefined> {
    ...
    const [task] = await db.select({
      ...
      vendorNeeded: tasks.vendorNeeded,
      vendorSatisfactionRating: tasks.vendorSatisfactionRating,
      vendorNotes: tasks.vendorNotes,
    ...
    const [row] = await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          preference: consent.preference ?? false,
          decidedAt: new Date(),
          updatedAt: new Date(),
        },
      })
