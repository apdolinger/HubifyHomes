...
export class ObjectStorageService {
  ...
  async getFormFileUploadURL(formId: number, fieldId: number): Promise<string> {
    const privateObjectDir = this.getPrivateObjectDir();
    const objectId = `${formId}_${fieldId}_${randomUUID()}`;
    const fullPath = `${privateObjectDir}/form-uploads/${objectId}`;
