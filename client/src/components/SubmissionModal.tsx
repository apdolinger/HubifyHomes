...
export function SubmissionFormContent({ onSuccess, compact }: SubmissionFormContentProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <SubmissionFormContent compact onSuccess={() => setTimeout(() => onOpenChange(false), 3000)} />
      </DialogContent>
    </Dialog>
  );
}
