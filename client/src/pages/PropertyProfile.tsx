  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(property as any)?.communityId && (() => {
          const currentCommunity = (communities as any[])?.find((c: any) => c.id === (property as any).communityId);
            ...
            <Dialog open={isEditOverviewDialogOpen} onOpenChange={setIsEditOverviewDialogOpen}>
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Update basic information and contact details for {currentCommunity?.name}
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={currentCommunity?.gateCode || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={currentCommunity?.propertyManagerName || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={currentCommunity?.emergencyContact || ""}
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.hoaMailingAddress || ""}
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.notes || ""}
            ...
            <Dialog open={isEditRulesDialogOpen} onOpenChange={setIsEditRulesDialogOpen}>
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Update rules and guidelines for {currentCommunity?.name}
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.rentalRestrictions || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.petPolicy || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.parkingRules || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.noiseRestrictions || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.vendorAccessProcedures || ""}
            ...
            <Dialog open={isEditScheduleDialogOpen} onOpenChange={setIsEditScheduleDialogOpen}>
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Update maintenance and event schedules for {currentCommunity?.name}
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={currentCommunity?.trashRecyclingPickup || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={currentCommunity?.bulkTrash || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={currentCommunity?.landscapeMaintenance || ""}
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        defaultValue={currentCommunity?.communityEvents || ""}
