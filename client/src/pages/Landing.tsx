    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-16 pb-4 text-center">
          <img src={HUBIFY_HOMES_LOGO_URL} alt={HUBIFY_HOMES_LOGO_ALT} className="h-20 sm:h-24 w-auto mx-auto mb-6" />
          <h1 className="text-4xl font-bold text-slate-900 sm:text-5xl md:text-6xl">Hubify</h1>
