...
export const portalUsers = pgTable("portal_users", {
  ...
  lastName: varchar("last_name"),
  phone: varchar("phone"),
  role: varchar("role").$type<"staff"|"vendor"|"resident"|"owner">().notNull(),
...
export const onboardingProspects = pgTable("onboarding_prospects", {
  ...
  // Submission-specific fields (populated when prospect came from public form)
  firstName: varchar("first_name"),
  lastName: varchar("last_name"),
  website: varchar("website"),
  businessType: varchar("business_type"),
  serviceArea: varchar("service_area"),
  estimatedHomes: integer("estimated_homes"),
  currentMgmtMethod: varchar("current_mgmt_method"),
